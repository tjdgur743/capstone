...
class DeepSort(object):
    def __init__(self, model, device, max_dist=0.2, max_iou_distance=0.7, max_age=70, n_init=3, nn_budget=100
        ...
        # Custom code
        self.total_space_num=total_space_num
        self.parked_car_num=0
    ...
    def update(self, bbox_xywh, confidences, classes, ori_img):
        ...
        self.tracker.update(detections, classes, confidences, self.parked_car_num)
        ...
        for track in self.tracker.tracks:
            ...
            center_of_box=[int((x1+x2)/2), int((y1+y2)/2)]
            ...
            if track.timer_alarm.signal: # Parked car detected
                ...
                message="Parking detected, parked cars: "+str(self.parked_car_num)+", new cars: "+str(new_car_num)
